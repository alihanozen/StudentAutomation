...
public class ingogretmen extends ogretmen implements interogretmen,ortak {
	Connection con;
	static Scanner scan = new Scanner(System.in);

	public ingogretmen(String name, String surname, int id, String password) {
	...
	public static void ogrencigoster(Connection con) {
		...
		try {
			...
			while (res.next()) {
				...
				if (d1.equalsIgnoreCase("ingilizce")) {
					System.out.println(adi + " " + soyadi + " " + no + " " + d1);
				}
				if (d2.equalsIgnoreCase("ingilizce")) {
	...
	public static void notgir(Connection con, int id) {
		...
		try {
			...
			while (res.next()) {
				...
				float a;
				if (as.equalsIgnoreCase("ingilizce")) {
					System.out.println("İngilizce Notu: ");
					a = scan.nextFloat();
				...
				if (bs.equalsIgnoreCase("ingilizce")) {
					System.out.println("İngilizce Notu: ");
					a = scan.nextFloat();
